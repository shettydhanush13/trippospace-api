  ...
  ForgotPassword : (req, Users, Organizer) => {
      return new Promise((resolve, reject) => {
          if(req.body.platform === "user"){
              DB = Users
              query = { email : req.body.mail }
          }else{
              DB = Organizer
              query = { "contact.mail" : req.body.mail }
          }
          DB.findOne(query, (err, user) => {
              if (user !== null) {
    ...
    Quote : req => {
      return new Promise((resolve, reject) => {
                  ...
                  const msg = {
                      ...
                      subject: `TRIPPOSPACE QUOTE RECIEVED`,
                      text: 'your travel quote has been recieved',
                      html: `<body class="iOSGmailAppfix" style="margin:0; padding:0; background-color:#F2F2F2;">
                      <table id="EmailWrapper" cellpadding="0" cellspacing="0" border="0" align="center"
                      style="background-color: #f2f2f2; border:none; font-size: 0; width:100%">
                        <tr>
                            ...
                            border="0" align="center" width="640">
                              <tr>
                                <td style="padding-bottom:10px;">
                                  ...
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #2a2a2a; font-weight:bold; padding:0 25px 20px 25px;">QUOTE RECIEVED</td>
                                  </tr>
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Destination : ${req.body.destination}</td>
                                  </tr>
                                  <tr>
                                    <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Departure city : ${req.body.departure}</td>
                                </tr>
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Date : ${req.body.time}</td>
                                  </tr>
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Duration : ${req.body.days} days</td>
                                  </tr>

                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Travelers : ${req.body.travelers}</td>
                                  </tr>
                                  ...
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">${req.body.email} - ${req.body.phone}</td>
                                  </tr>
                                  <tr>
                                      <td style="font-family:'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:15px; color: #4a494b; padding:0 25px 20px 25px;">Our travel experts will get back to you soon with the best options. Thank you for choosing Trippospace.</td>
                                  </tr>                                    
                                  </table>
                                  </td>
                              </tr>
